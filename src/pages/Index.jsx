...
const Index = () => {
  return (
    <Container maxW="container.xl" p={4}>
      ...
      <Flex as="section" direction={{ base: "column", md: "row" }} justifyContent="space-between" alignItems="center" p={12} my={12} bg={useColorModeValue("purple.500", "purple.800")} borderRadius="lg">
